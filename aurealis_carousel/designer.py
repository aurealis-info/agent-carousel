...
def _build_prompt(
    *, brand: dict, brand_css: str, pairing: dict, emphasis_font: Optional[dict],
    ...
    sections = [
        ...
        "- Honor the composition template intent",
        "- The hero_word, if provided, must receive a distinct visual treatment (color shift, weight shift, family shift, or size shift) — make it punch",
